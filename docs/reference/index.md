...
- [`SCR_002_Clinical_Data`](SCR_002_Clinical_Data.md) : ECG data set
  "ECG Effects of Ranolazine, Dofetilide, Verapamil, and Quinidine"
- [`add_bl_popmean()`](add_bl_popmean.md) : Add population mean column
- [`add_ntile()`](add_ntile.md) : Add ntiles (quantiles) for a specific
  column across all subjects
...
- [`average_triplicates()`](average_triplicates.md) : Average triplicate
  observations
- [`cqtc()`](cqtc.md) : Make a cqtc object
...
- [`hr_by_time_plot()`](hr_by_time_plot.md) : Plot HR over time
...
- [`quinidine_cqtc`](quinidine_cqtc.md) : Quinidine c-QTc data set
- [`ranolazine_cqtc`](ranolazine_cqtc.md) : Ranolazine c-QTc data set
- [`rr_plot()`](rr_plot.md) : Plot ECG parameter by RR interval
- [`subjects()`](subjects.md) : Generic subjects function
- [`subjects(`*`<cqtc>`*`)`](subjects.cqtc.md) : Subjects in a cqtc
  object
